...
public class MaximumElements {
	...
	/*
	 * TC -1.1 Given Max Number at 1st Position return the Same Number Ensure the
	 * test data has Max Number in the First position
	 */
	/*
	 * Tc -1.2 Given Max Number at 2nd Position return the Same Number Ensure the
	 * test data has Max Number in the Second position
	 */
	/*
	 * TC -1.3 Given Max Number at 3rd Position return the Same Number Ensure the
	...
	public static void findMax(Integer firstNumber, Integer secondNumber, Integer thirdNumber) {
		...
		System.out.println(
				maximumNumber + " is maximum out of " + firstNumber + ", " + secondNumber + " and " + thirdNumber);
	}
	...
	public static void findMax(String firstString, String secondString, String thirdString) {
		...
		System.out.println(
				maximumString + " is maximum out of " + firstString + ", " + secondString + " and " + thirdString);
